        ...
        <div class="container m-b-5">
            ...
            <div class="row main-content">
                ...
                <div class="row main-content-list-item d-flex justify-content-between mt-5"
                    ...
                    <div class="hightlights-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 col-12 ">
                        <div class="hightlights-item-img col-md-12 col-sm-6 w-100">
                            <img src="FE/images/coin.jpg" alt="">
                        </div>
                        <div class="hightlights-item-info col-md-12 col-sm-6 w-100">
...
<footer class="w-100">
    <div class="container">
        <div class="row d-flex  align-items-start">
            <div class="col-12 col-md-4 logo-footer pl-0">
                <img src="FE/images/Artboard 2 copy.png" alt="">
            </div>
            <div class="col-12 col-md-4  title-footer ">
            ...
            <div class="col-12 col-md-4 link-footer d-flex  flex-column align-items-center ">
                <p>Liên hệ với LTC</p>
...
<script>
    $().ready(function () {
        ...
        const str = `<div class="hightlights-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 col-12 ">
                            <div class="hightlights-item-img col-md-12 col-sm-6 w-100">
                                <img src="FE/images/coin.jpg" alt="">
                            </div>
                            <div class="hightlights-item-info col-md-12 col-sm-6 w-100">
