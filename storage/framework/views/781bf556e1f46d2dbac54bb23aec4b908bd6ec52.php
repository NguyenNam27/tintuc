    ...
    <div class="main">
        <div class="container mb-8">
            ...
            <div class="row news-tittle">
                <?php $__currentLoopData = $show_two; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 h-100">
                    <div class=" w-100 news-same">

                        <div class=" news-same-img">
                            <img src="<?php echo e(asset($sh->image)); ?>" alt="" style="width: 100%;">
                        </div>
                        <div class=" w-100 news-same-info">
                            <a href="<?php echo e(route('details_post',['id'=>$sh->id])); ?>"><?php echo e($sh->title); ?></a>
                            <span><?php echo e(strip_tags($sh->description)); ?></span>
            ...
            <div class="row ">
                <div class="col-9 news-left">
                    <div class="row ">
                        <?php $__currentLoopData = $bit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="news-left-item col-6 d-flex m-t-25">
                            ...
                            <div class="news-left-item-info w-50">
                                ...
                                <p><?php echo e(strip_tags($value->description)); ?></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
