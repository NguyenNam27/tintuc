                ...
                <div class="row main-content">
                    <div class="col-12 h-100 ">
                        ...
                        <div class=" w-100 news-same hightlights">
                            <?php $__currentLoopData = $noibat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class=" news-same-img hightlights-img">
                                    <img src="<?php echo e(asset($noi->image)); ?>" alt="" style="width: 100%;">
                                </div>
                                <div class=" w-100 news-same-info hightlights-info">
                                    <a href="<?php echo e(route('details_post',['id'=>$noi->id])); ?>"><?php echo e($noi->title); ?></a>
                                    <span><?php echo e(strip_tags($noi->description)); ?></span>
