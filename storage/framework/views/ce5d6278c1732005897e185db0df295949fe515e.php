<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Thêm thông tin loại tin <a href="<?php echo e(route('admin.subcategory.index')); ?>" class="btn bg-purple "><i class="fa fa-plus"></i> Danh sách loại tin</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action = "<?php echo e(route('admin.subcategory.store')); ?>" method = "post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="box-body">
                                <div class="col-md-6">
