<?php $__env->startSection('kienthuc'); ?>
    <section>
        <div class="main">
...
<?php $__env->startSection('js_kienthuc'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function load_kienthuc(id="",token){
                $.ajax({
                    url:'<?php echo e(route('load_kienthuc')); ?>',
                    method:'POST',
...
<?php echo $__env->make('FE.master.layout_kienthuc', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>