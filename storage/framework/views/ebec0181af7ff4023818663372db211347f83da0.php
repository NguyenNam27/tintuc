<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                DANH SÁCH DANH MỤC <a href="<?php echo e(route('admin.category.create')); ?>" class="btn bg-purple btn-flat"><i
                            ...
                            <table class="table table-border">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="item-<?php echo e($category->id); ?>">
                                        ...
                                        <td><?php echo e($category->active==1 ? 'hiển thị' : 'No'); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('admin.category.edit',['edit'=>$category->id])); ?>"
                                               class="btn btn-warning btn-edit"><i class="fa fa-pencil"></i></a>
                                            <button data-id="<?php echo e($category->id); ?>" class="btn btn-danger btn-delete"><i
                                                    class="fa fa-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
